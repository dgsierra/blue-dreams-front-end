    ...
    <div className="bg-1">
      ...
      <div className="mt-5 ms-5">
        ...
        <p className="text-dark w-50 mt-5 mx-auto">
          ...
          Whether you're looking for a romantic getaway or a fun-filled family vacation, we have a yatch that will meet your needs.
          ...
          From start to finish, we'll be there to assist you with every aspect of your trip, including selecting the right yatch, planning your itinerary, and providing you with all the information you need to make the most of your time on the water.
          At Blue Dreams Yatch, we pride ourselves on providing our customers with the best possible experience. Whether you're a seasoned yatch enthusiast or a first-time renter, we're confident that you'll have a wonderful time on one of our yatches.
