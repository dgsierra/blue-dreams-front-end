    ...
    <div className="bg1">
      <div className="mt-3 ms-5">
        ...
        <div className="text-center">
          <button type="submit" className="btn navbar-toggler bg-dark p-2 text-decoration-none link-light mb-4" data-bs-toggle="modal" data-bs-target="#staticBackdrop">BOOK NOW</button>
        </div>
                ...
                <fieldset className="p-5">
                  ...
                  <div className="mb-3">
                    <label htmlFor="city" className="form-label text-light">
                      City
                      <select name="city" id="Select" className="form-select">
                        <option>Select</option>
                  ...
                  <div className="mb-3">
                    <label htmlFor="Select" className="bg form-label text-light">
                      Start Date
                    ...
                    <label htmlFor="disabledSelect" className="form-label mt-3 text-light">
                      End Date
                      <div className="input-group date" id="datepicker">
                        <input type="text" className="form-control" />
                        <span className="input-group-append">
                    ...
                    <div className="text-center d-flex justify-content-center row">
                      <p className="form-label mt-3 text-light">Cost</p>
                      <card name="display" type="display" className="form-control form1 p-3 w-50 d-flex">500</card>
                    </div>
                  </div>
